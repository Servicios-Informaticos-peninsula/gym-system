<div class="modal fade" id="addMembershipType" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Agregar tipo membresia</h5>
            ...
            <form action="{{ route('Membership-type.store') }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div>
                                <label class="@error('name') border-danger text-danger @enderror">Nombre tipo membresia</label>
                        ...
                        <div class="col-6">
                            <div>
                                <label class="@error('price') border-danger text-danger @enderror">Precio Membresia</label>
                                <div class="form-group mb-4">
                                    <div class="input-group input-group-alternative">
