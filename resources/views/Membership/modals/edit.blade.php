<div class="modal fade" id="membership-{{ $membership->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Editar membresia</h5>
            ...
            <form action="{{ route('Membership.update', $membership->id) }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="col-12">
                        <label class="float-start">Nombre Miembro</label>
