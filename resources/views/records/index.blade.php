    ...
    <div class="container-fluid" id="capa_index_record">
        <header class="card px-2 py-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                {{-- <a type="button" class="btn btn-primary" id="nuevo_expediente"> --}}
                    <a type="button" class="btn btn-primary" href="{{route('record.create')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-plus-circle me-1" viewBox="0 0 16 16">
                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                        <path
...
@section('scripts')
    ...
    <script src="{{ asset('js_modulos/expediente_index.js') }}"></script>
@endsection
