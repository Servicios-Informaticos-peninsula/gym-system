        ...
        <div class="modal-content">
            ...
            <form action="{{ route('products.store') }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <label class="@error('product_name') border-danger text-danger @enderror">Nombre Producto</label>
                            <div class="form-group mb-4">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control @error('product_name') is-invalid @enderror" type="text"
                                        product_name="product_name" placeholder="Nombre Producto">
                                </div>
                                @error('product_name')
                    ...
                    <div>
                        <label class="@error('product_description') border-danger text-danger @enderror">Descripción Producto</label>
