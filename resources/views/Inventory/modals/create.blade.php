        ...
        <div class="modal-content">
            ...
            <form action="{{ route('inventory.store') }}" method="POST">
                <div class="modal-body">
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group mb-4">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <select class="form-control @error('product_status') is-invalid @enderror" type="text"
                                        name="product_status">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <label class="@error('minimum_alert') border-danger text-danger @enderror">Alerta Minima</label>
                            <div class="form-group mb-4">
                                <div class="input-group input-group-alternative">
                                    <span
